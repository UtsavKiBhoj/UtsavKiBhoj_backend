...
from .views import CreateEventView, CreateEventLocationView, EventListView, EventDetailView, EventDelete, EventUpdate
...
urlpatterns = [
    ...
    path('update/<int:pk>/', EventUpdate.as_view(), name='event-update'),
]
